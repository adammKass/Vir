...
const Section = ({ name, image, imageMobile, subheading }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute w-full h-[120%] -z-10 will-change-transform translate-z-0.5"
        style={{ y: yBg }}
      >
      ...
      <motion.div
        style={{ y: yText }}
        className="content text-white md:self-start text-left flex flex-col gap-4 mb-[10vh] lg:bg-linear-to-r lg:from-black/20 lg:to-transparent lg:to-60% py-4 will-change-transform translate-z-0.5"
      >
